...
export class GerantService {
  ...
  assignerGerantAgence(id_gerant: number, id_agence: number) {
    return this._http.put(
      `${this.assigneUrl}/${id_gerant}/agence/${id_agence}`,
      null,
      {
        headers: new HttpHeaders({
          'Access-Control-Allow-Origin': '*',
  ...
  assignerGerantConseiiler(id_gerant: number, id_conseiller: number) {
    return this._http.put(
      `${this.assigneUrl}/${id_gerant}/conseiller/${id_conseiller}`,
      null,
      {
        headers: new HttpHeaders({
          'Access-Control-Allow-Origin': '*',
